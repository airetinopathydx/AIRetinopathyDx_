...
def findToRemoveClass(df, className):
	randomPatientData = {'patient.number':231}
	while(randomPatientData['patient.number'] == 231 or
	randomPatientData['patient.number'] == 232 or
	randomPatientData['patient.number'] == 321 or
	randomPatientData['patient.number'] == 322 or
	randomPatientData['patient.number'] == 477 or
	randomPatientData['patient.number'] == 478 or
	randomPatientData['patient.number'] == 704 or
	randomPatientData['patient.number'] == 705 or
	randomPatientData['patient.number'] == 706 or
	randomPatientData['patient.number'] == 707 or
	randomPatientData['patient.number'] == 708 or
	randomPatientData['patient.number'] == 709):
...
mainDataFrame.to_csv("save\dfNewExperiment_0.3_40Hz_Balanced.csv", index=False, header=True)