...
#frequency <= 40 Hz and >= 2.5 Hz, time window for each observation (size.bin) = 60000 ms,
...
m2.model.control.humans.plot <- SingleModelROCPlot(m2.model.control.humans$performance, "Modelo SANO vs ENFERMO  2.5Hz - 40Hz")
