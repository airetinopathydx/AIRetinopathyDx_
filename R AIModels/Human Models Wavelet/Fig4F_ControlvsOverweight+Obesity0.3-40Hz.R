...
m2.photo.60s.t <- read.csv("DataH_and_A/wavelet2022/HumansBalanced/dfControlvsOverweight+Obesity_0.3_40Hz_2ndCat.csv")
...
m2.model.control.humans.plot <- SingleModelROCPlot(m2.model.control.humans$performance, "Model Health vs OW + Obesity  0.3 - 40Hz")
