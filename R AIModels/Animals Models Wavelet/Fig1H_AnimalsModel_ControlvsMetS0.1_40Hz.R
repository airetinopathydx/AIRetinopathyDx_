...
#Animal Models, Control vs MetS (Neotomodon Alstoni Mice), Balanced
...
mA12.photo.60s.t <- read.csv("DataH_and_A/wavelet2022/AnimalsBalanced/dfControlvsMetS_NeotomodonAlstoniMice0.1_40Hz.csv")
