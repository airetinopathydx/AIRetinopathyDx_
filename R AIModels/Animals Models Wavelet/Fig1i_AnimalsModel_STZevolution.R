...
mA18.photo.60s.t <- read.csv("DataH_and_A/wavelet2022/AnimalsBalanced/dfGrupo STZ mice evolution CH1y2_0.1_40HzBalanceo.csv")
#mA18.photo.60s.t <- read.csv("DataH_and_A/wavelet2022/dfGrupo STZ mice evolution CH1y2_0.1_40Hz.csv")
...
mA18.model.control.animals.plot <- SingleModelROCPlot(mA18.model.control.animals$performance, "Modelo STZ EVO  0.1Hz - 40Hz")
plot(mA18.model.control.animals.plot, type="roc")
