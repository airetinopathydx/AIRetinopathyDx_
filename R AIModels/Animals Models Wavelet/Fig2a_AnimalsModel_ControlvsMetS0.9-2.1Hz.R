...
#Animal Models, Control vs MetS, Balanced
...
mA13.photo.60s.t <- read.csv("DataH_and_A/wavelet2022/AnimalsBalanced/dfControlvsMetS_NeotomodonAlstoniMice0.9_2.1Hz.csv")
