...
mA5.photo.60s.t <- read.csv("DataH_and_A/wavelet2022/AnimalsBalanced/dfGrupo LE vs P23H rats_0.9_2.1HzBalanceo.csv")
#mA5.photo.60s.t <- read.csv("DataH_and_A/wavelet2022/dfGrupo LE vs P23H rats_0.9_2.1Hz.csv")
...
mA5.model.control.animals.plot <- SingleModelROCPlot(mA5.model.control.animals$performance, "Modelo CTRL vs P23H  0.9Hz - 2.1Hz")
