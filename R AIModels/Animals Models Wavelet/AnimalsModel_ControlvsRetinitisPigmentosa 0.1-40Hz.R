...
#Animal Models, Control vs ReinitisPigmentosa, Balanced
...
mA4.photo.60s.t <- read.csv("DataH_and_A/wavelet2022/AnimalsBalanced/dfControlvsRetinitisPigmentosa_P23Hrats0.1_40Hz.csv")
...
mA4.model.control.animals.plot <- SingleModelROCPlot(mA4.model.control.animals$performance, "Model Control vs Retinitis Pigmentosa  0.1Hz - 40Hz")
