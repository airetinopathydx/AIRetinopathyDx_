...
mA16.photo.60s.t <- read.csv("DataH_and_A/wavelet2022/AnimalsBalanced/dfGrupo CTL vs HFD validación_0.9_2.1HzBalanceo.csv")
#mA16.photo.60s.t <- read.csv("DataH_and_A/wavelet2022/dfGrupo CTL vs HFD validación_0.9_2.1Hz.csv")
...
mA16.model.control.animals.plot <- SingleModelROCPlot(mA16.model.control.animals$performance, "Modelo CTRL vs HFD  0.9Hz - 2.1Hz")
